...
interface
uses classes, sysutils, DRT.LZ4Lib,DRT.YWTypes;

const
  LZ4_VERSION_MAJOR = DRT.LZ4Lib.LZ4_VERSION_MAJOR;
  LZ4_VERSION_MINOR = DRT.LZ4Lib.LZ4_VERSION_MINOR;
  LZ4_VERSION_RELEASE = DRT.LZ4Lib.LZ4_VERSION_RELEASE;
  LZ4_VERSION_NUMBER = LZ4_VERSION_MAJOR*100*100+LZ4_VERSION_MINOR*100+
    LZ4_VERSION_RELEASE;
  LZ4_VERSION_STRING = '1.9.3';
  LZ4HC_CLEVEL_DEFAULT = DRT.LZ4Lib.LZ4HC_CLEVEL_DEFAULT;
