...
interface
uses Sysutils,Classes,DRT.xxhashlib ,DRT.YWSTRUTIL, DRT.YWTypes;
...
begin
  bufferpool128k.FreeBuffer(Pointer(b));
end;
...
begin
  move(Src._state^,Dest._state^,SizeOf(XXH3_state_t));
end;
...
begin
  move(Src._state^,Dest._state^,SizeOf(XXH64_state_t));
end;
...
begin
  move(Src._state^,Dest._state^,SizeOf(XXH32_state_t));
end;
