...
interface
uses classes, sysutils, DRT.ZSTDLib,DRT.YWTypes;

const
  ZSTD_VERSION_MAJOR = DRT.ZSTDLib.ZSTD_VERSION_MAJOR;
  ZSTD_VERSION_MINOR = DRT.ZSTDLib.ZSTD_VERSION_MINOR;
  ZSTD_VERSION_RELEASE = DRT.ZSTDLib.ZSTD_VERSION_RELEASE;
  ZSTD_VERSION_NUMBER = ZSTD_VERSION_MAJOR*100*100+ZSTD_VERSION_MINOR*100+
    ZSTD_VERSION_RELEASE;
  ZSTD_VERSION_STRING = DRT.ZSTDLib.ZSTD_VERSION_STRING;
  ZSTD_CLEVEL_DEFAULT = DRT.ZSTDLib.ZSTD_CLEVEL_DEFAULT;
...
begin
  Result:=BufferPool256K.GetBuffer
end;

procedure FreeBuffer(var b : Pointer); inline;
begin
  BufferPool256K.FreeBuffer(b)
end;
